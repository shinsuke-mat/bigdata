...
public class PosUtils {
	 ...
	 * POSファイルの総レシート枚数
	 */
	public static final int N_TOTAL_RECEIPTS = 23948680;
	...
	public static void setupRuntimeEnvironment() {
		...
		System.setProperty("hadoop.tmp.dir", "C:/pbl/hadoop/tmp");
		//System.setProperty("java.library.path", "C:/pbl/hadoop/bin");
